                      ...
                      <td>
                        <button type="button" class="btn btn-primary" data-bs-toggle="dropdown"><i class="bi bi-three-dots"></i></button>
                            <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                <li><a class="dropdown-item" href="{{ url("admin/categorias/edit/{$item->id}") }}">Editar</a></li>
                                <li><a class="dropdown-item" href="{{ url("admin/categorias/delete/{$item->id}") }}">Eliminar</a></li>
                            </ul>
                        </td>
                    </tr>
                    @endforeach

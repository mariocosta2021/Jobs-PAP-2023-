...
<h3 class="fs-24 text-black font-w600 mr-auto mb-2 pr-3">Criar Curriculo</h3>
...
<input name="fotoPerfil" type="file" class="form-control" value="{{ isset($perfilCliente->nomeCliente) ? Auth::user()->name : Auth::user()->name }}" >
</div>
</div>
<div class="col-xl-4 col-sm-6">
<div class="form-group">

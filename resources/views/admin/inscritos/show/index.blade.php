                        ...
                        <div class="card recent-sales overflow-auto">
                            ...
                            <div class="filter">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                    ...
                                    <li><a class="dropdown-item" href="{{ route('admin.relatorio.inscritos') }}">Gerar PDF</a></li>
                                </ul>
                            </div>

                            <div class="card-body">
                                <h5 class="card-title">Lista de Candidatos Inscritos às Vaga</h5>
                                Vagas Abertas: {{ $numVagas->tempoVaga }}<br>
                                Total Candidatos: {{ $total }}<br>
                                <button type="button" class="btn btn-primary my-2" data-bs-toggle="modal" data-bs-target="#basicModal">
                                    Filtrar Dados
                                </button>

...
@section('titulo', 'Procurar Emprego')
@section('content')
        ...
        <div class="container-fluid">
            ...
            <div class="d-flex flex-wrap mb-4 align-items-center search-filter">
                <div class="mr-auto mb-2 pr-2">
                    <h6 class="text-black fs-16 font-w600 mb-1">Total de Empregos {{ $totalempregos }}</h6>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center mt-4">
                                        <a href="{{ route('admin.buscar.detalhes', $item->id) }}"
                                            class="btn btn-primary light btn-rounded mr-auto">saber mais
                                        </a>
                                    </div>
                                </div>
                            </div>

...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        if (Auth::user()->level == "Administrador") {
            ...
            $response['vagas'] =  Vaga::where('fk_user', Auth::user()->id)->count();
            $response['candidatos'] = Candidaturas::with('canditados')->where('fk_publicador', Auth::user()->id)->count();
